// Configure Casper.
// -----------------
// From: https://github.com/DavidDurman/ghost-qunit-runner
...
function printResults() {
    var result = casper.evaluate(getTestResult);
    ...
    if (screenshot !== undefined) {
        ...
        casper.captureSelector(screenshot, '#qunit-tests');        
    }
}
...
casper.start(url, function() {
    casper.waitFor(stopCondition, printResults, printError, timeout);
});
